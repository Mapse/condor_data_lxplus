...
class EventSelectorProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        try:
            ...
            hlt_char = ak.zip({**get_vars_dict(events, hlt_cols_charm_2017_2018)})
        ...
        ## For psi(2S)
        #Dimu = ak.mask(Dimu, ((Dimu.mass > 2.95) & (Dimu.mass < 4.00)))
        ...
        # Dimuon rapidity
        dimu_rap_cut = (np.absolute(Dimu.rap) <= 2.4)
        ...
        Dstar = Dstar[np.absolute(Dstar.rap) < 2.4]
